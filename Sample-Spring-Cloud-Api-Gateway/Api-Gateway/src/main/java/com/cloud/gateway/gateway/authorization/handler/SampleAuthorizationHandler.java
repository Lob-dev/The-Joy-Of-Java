package com.cloud.gateway.gateway.authorization.handler;

import com.cloud.gateway.gateway.authorization.proxy.AuthorizationServiceProxy;
...
@Slf4j
@Service
public record SampleAuthorizationHandler(
        AuthorizationServiceProxy serviceProxy
) {
